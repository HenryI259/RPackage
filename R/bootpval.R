...
#' @param iter amount of iterations for the bootstrap
#' @param mu0 mean of the null hypothesis
#' @param test type of test
#'
#' @return a histogram showing the T-Distribution and p-value areas
#' @importFrom graphics title
#' @export
#'
#' @examples
#' \dontrun{
#' bootpval(x=x1,mu0=22)
#' }
